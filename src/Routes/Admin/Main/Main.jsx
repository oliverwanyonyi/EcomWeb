...
const Main = () => {
  ...
  return (
    <div className={showSideBar?"sidebar-active":""}>
      ...
      <div className="main-content">
        <nav className="admin-header">
          <div className="d-flex justify-content-between align-items-center bg-white px-2 py-3">
            <span className={showSideBar?"fas fa-arrow-alt-circle-left nav-icon":"fas fa-arrow-alt-circle-right nav-icon"} onClick={()=>setShowSideBar(!showSideBar)}></span>
            ...
            <div className="admin-header-nav-left">
              <ul className="nav-list d-flex align-items-center">
                ...
                <li className="nav-list-item">
                  <div className="nav-list-item-label" onClick={()=>setShowMenu(!showMenu)}>
      ...
      {currPath === '/admin'?<Analytics/>:currPath === '/admin/product/new'?<CreateProduct/>:currPath==="/admin/categories/new"?<Category/>:currPath==="/admin/products/all"?<ProductList/>:""}
      </div>
    </div>
  );
};
